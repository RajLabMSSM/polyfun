...
def load_ld(ld_prefix, sumstats_prefix):
    # ld_prefix="./echolocatoR/tools/polyfun/LD_temp/"
    sumstats_prefix="~/Desktop/Fine_Mapping/Data/GWAS/Nalls23andMe_2019/_genome_wide/PolyFun/sumstats_munged"
    # load SNPs info
    snps_filename_parquet = sumstats_prefix +'.parquet'
    snps_filename_gz = sumstats_prefix +'.gz'
